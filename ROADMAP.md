...
| cli-docs 对外面双标准 skill 增编 | 已完成 | 2026-09-17 第七十七批:总台立单,evo-adr 第五 skill(甲面 README 四节骨架标杆研究定稿、乙面 agent 三件 --llms 手册加 JSON 协议加自省);ADR-0014 修订清单为十一 skill,REQ-006;私有名零出现 [实证: 四标杆 README 实读加 hst 与 omc 契约实读加 pytest 全绿] |
